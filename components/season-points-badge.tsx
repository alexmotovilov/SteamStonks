  ...
  return (
    <div className="hidden sm:flex items-center relative" style={{ width: "9.3vh", height: "9.3vh" }}>
      <span
        ...
        style={{ paddingBottom: "1.5vh", transform: "translate(calc(-0.7vh - 20px), 19px)" }}
      >
        <span className="flex items-center" style={{ gap: "0.3vh", fontSize: "1.9vh", textShadow: "0 0 8px rgba(0,0,0,1), 0 1px 4px rgba(0,0,0,1), 0 0 2px rgba(0,0,0,1)" }}>
          <img
